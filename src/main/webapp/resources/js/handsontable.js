...
HandsontableEditor.prototype.open = function() {
  /* add a top dinamically, changing the top property */
  var logo = document.getElementsByClassName('htNoWrap htAutocomplete current')[0];

  if (typeof logo !== "undefined"){
    var logoTextRectangle = logo.getBoundingClientRect();
    $('.handsontable.listbox').css('top', parseInt(logoTextRectangle.top + 25) + 'px');
  }
